...
import Img1 from '../../assets/7309681.jpg'
import tutorialsdev from '../../assets/user.png'
					...
					<div className='p-14'>
						{
							messages?.messages?.length > 0 ?
								...
								}) : <div className='text-center text-lg font-semibold mt-24'>No Conversation Started</div>
						}
					</div>
				</div>
				{
